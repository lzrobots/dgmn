...
_C.MODEL.RESNETS.STAGE_WITH_DW = (False, False, False, False)
_C.MODEL.RESNETS.DYNAMIC_WEIGHT = CN()
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.GROUP = 1
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.KERNEL = 3
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.DILATION = (1, 4, 8, 12)
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.SHUFFLE = False
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.DEFORM = 'none'
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.INSERT_POS = 'after1x1'
_C.MODEL.RESNETS.DYNAMIC_WEIGHT.DOMAIN = 'block'
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "/scratch_new/engs1870/maskrcnn/e2e_mask_rcnn_R_50_FPN_001da_33_re_2x"
# _C.OUTPUT_DIR = "./models/test/"
